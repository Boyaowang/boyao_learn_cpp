...
) const
{
  ...
  for (label i = 0; i < reactionNum; i++)
  {
    ...
    // solid products
//     for(auto it = solidStoiDatas_[i].begin();
//     it != solidStoiDatas_[i].end(); it++)
//     {
//       productName = it->first();
//       if (productName == "Null")
//       {
//         break;
//       }
//       
//       productId = solidLocalIdMap_.at(productName);
//       productMolarMass = solidMolarMassMap_.at(productName);
//       
//       calculate the increase of the product
//       dMassSOLID[productId]-=
//       moleReact*it->second()*productMolarMass;
//     }
    ...
    // gas products
//     for(auto it = gasStoiDatas_[i].begin();
//     it != gasStoiDatas_[i].end(); it++)
//     {
//       productName = it->first();
//       
//       if (productName == "Null")
...
//       }
//       
//       productId = gasLocalIdMap_.at(productName);
//       productMolarMass = gasMolarMassMap_.at(productName);
//       
//       calculate the increase of the product
...
//             Info << "solidName " << solidName  << " solidMM " << MM
//             << " stoi " << stoiVal << nl;
