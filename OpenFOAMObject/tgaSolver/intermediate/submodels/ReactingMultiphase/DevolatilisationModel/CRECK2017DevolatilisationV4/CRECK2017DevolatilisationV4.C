...
#include "CRECK2017DevolatilisationV4.H"

// * * * * * * * * * * * * * * * * Constructors  * * * * * * * * * * * * * * //

template<class CloudType>
Foam::CRECK2017DevolatilisationV4<CloudType>::CRECK2017DevolatilisationV4
(
...
Foam::CRECK2017DevolatilisationV4<CloudType>::CRECK2017DevolatilisationV4
(
  const CRECK2017DevolatilisationV4<CloudType>& dm
)
:
...
template<class CloudType>
void Foam::CRECK2017DevolatilisationV4<CloudType>::calculate
(
  const scalar dt,
  const scalar age,
  const scalar mass0,
...
template<class CloudType>
void Foam::CRECK2017DevolatilisationV4<CloudType>::readReactionDict
(
  const fvMesh& mesh
)
{
